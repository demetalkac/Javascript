const cities = ["Ankara", "Izmir", "Istanbul", "Viyana", "Mugla", "Gumushane"];
...
const getRandom = () => {
  ...
  cities.splice(0,0,...arr);//cities e arr yi ekledik 0. indexten basla 0 eleman sil arr yi ekle dedik.
};
